 ...
 * 人气主播
 */
public class PopularAnchorAdapter extends RecyclerView.Adapter<PopularAnchorAdapter.ViewHolder>implements View.OnClickListener{
    Context context;
    List<LiveModel> arrayList;
    private SoundTrackAdapter.OnItemClickListener mOnItemClickListener = null;

    public PopularAnchorAdapter(Context context, List<LiveModel> arrayList){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.item_live_hot_anchor, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            tv_item_hot_anchor_user_name = itemView.findViewById(R.id.tv_item_hot_anchor_user_name);
            ivCavar = itemView.findViewById(R.id.iv_item_hot_anchor_cover);
