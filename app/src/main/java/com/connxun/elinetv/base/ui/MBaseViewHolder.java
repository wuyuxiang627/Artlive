...
public class MBaseViewHolder extends BaseViewHolder {
    ...
    public MBaseViewHolder(final View view) {
        super(view);
    ...
    public BaseViewHolder setCardBackgroundColor(@IdRes int viewId, String colorString) {
        CardView view = getView(viewId);
        view.setCardBackgroundColor(Color.parseColor(colorString));
        return this;
    }
    public BaseViewHolder setCardBackgroundColor(@IdRes int viewId, int backColor) {
        CardView view = getView(viewId);
        view.setCardBackgroundColor(backColor);
        return this;
    }

    public BaseViewHolder setBackgroundResource(@IdRes int viewId, int imageId) {
        ImageView view = getView(viewId);
