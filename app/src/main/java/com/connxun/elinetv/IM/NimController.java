package com.connxun.elinetv.IM;
...
public class NimController extends NimContract.BaseNimController{
    ...
    public final static String MLIVEMODEL = "mLiveModel";
    ...
    public NimController(Context context, NimContract.Ui ui,String roomId) {
        this.context = context;
        this.ui = ui;
        this.roomId = roomId;
    }
    ...
    public void onHandleIntent(Intent intent) {
        mLiveModel = (LiveModel) intent.getSerializableExtra(MLIVEMODEL);
        roomId = intent.getStringExtra("ROOM_ID");
        if(mLiveModel != null){
            roomId = mLiveModel.getRoomid()+"";
        }
        // 注册监听
                ...
                .setCallback(new RequestCallbackWrapper<List<ChatRoomMember>>() {
                    ...
                    public void onResult(int code, List<ChatRoomMember> result, Throwable exception) {
                        if(result!=null){
                            ...
                            Log.e("MediaPreviewFragment","总集合: "+result.size());
                            totalMemberList.addAll(result);
                            if(hasReceivedNormalMember && hasReceivedGuestMember){
                                ui.refreshRoomMember(totalMemberList);
                            }
