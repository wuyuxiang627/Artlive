package com.connxun.elinetv.IM.activity;
...
public class InputActivity extends BaseActivity {
    ...
    public static void startActivityForResult(Context context, String text, InputConfig inputConfig, InputActivityProxy proxy) {
        ...
        ((BaseActivity) context).startActivityForResult(intent, REQ_CODE);
    }
    ...
    private void findViews() {
        // 根布局
        rootView = findViewById(R.id.input_layout);

        // 输入框
        messageEditText = findViewById(R.id.editTextMessage);
        MoonUtil.identifyFaceExpression(BaseApplication.baseContext, messageEditText, text, ImageSpan.ALIGN_BOTTOM);
