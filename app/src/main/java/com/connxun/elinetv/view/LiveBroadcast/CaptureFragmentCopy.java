 ...
 * 直播采集推流Fragment
 */
public class CaptureFragmentCopy extends BaseFragment implements INotifyListener,lsMessageHandler, CapturePreviewContract.CapturePreviewUi{
        ...
        seekBarRelativeWhiteningLayout.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                if(controller != null){
                    int param;
                    param = progress/20;
                    controller.setBeautyLevel(param);
                }
            }
            @Override
        ...
        seekBarRelativeFaceLiftLayout.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                if(controller != null){
                    ...
                    controller.setFilterStrength(param);
