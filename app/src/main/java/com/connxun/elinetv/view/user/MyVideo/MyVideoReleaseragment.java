 ...
 * 发布的视频
 */
public class MyVideoReleaseragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        videoPresenter.getVideoLIst(page+"","20",BaseApplication.getUserNo());
        videoPresenter.attachView(getReleaseListView);
...
//                addData();  //上拉加载添加数据
    ...
    public ITestView getReleaseListView = new ITestView() {
        @Override
        public void onSuccess(Object object) {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(getUserVisibleHint()) {
            Log.e("framgnet","MyVideoReleaseFragment 可见");
//            isVisible = true;
        } else {
            Log.e("framgnet","MyVideoReleaseFragment 不可见");
//            isVisible = false;
        }
    }
