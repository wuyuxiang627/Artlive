package com.connxun.elinetv.util.im;
...
public class NimSDKOptionConfig {
    ...
    public static SDKOptions getSDKOptions(Context context) {
        ...
        // 通知栏显示用户昵称和头像
        options.userInfoProvider = new NimUserInfoProvider(BaseApplication.getContext());
    ...
    static String getAppCacheDir(Context context) {
        ...
        if (TextUtils.isEmpty(storageRootPath)) {
            ...
            storageRootPath = Environment.getExternalStorageDirectory() + "/" + BaseApplication.getContext().getPackageName();
        }
...
//        config.notificationEntrance = WelcomeActivity.class;
        config.notificationSmallIconId = R.drawable.iocn_login_logo;
